        ...
        <div className="relative isolate overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-6 mt-16 lg:mt-4 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-24">
            <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-16">
              ...
              <h1 className="mt-12 text-5xl font-funnel-display font-semibold tracking-tight leading-[1.1] sm:leading-[1.025] text-[#F5F5F5] sm:text-6xl">Power your brand around community and engaged audience. <span className="block mt-6 text-2xl sm:text-3xl  tracking-normal text-green-500">We&apos;ll help you get there.</span></h1> 
