        ...
        <div className="relative isolate overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-6 mt-16 lg:mt-4 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-32">
            <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-16">
              ...
              <p className="mt-8 text-md max-w-2xl mx-auto text-pretty text-[#F5F5F5] sm:text-lg/8 sm:mx-0 sm:pr-6">Lean on us to help with the technical execution of your business&apos; digital engagement, either with inbound-, community- or agent-led GTM motion.</p>
