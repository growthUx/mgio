        ...
        <div className="relative isolate overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-6 mt-16 lg:mt-4 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-32">
            <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-16">
              ...
              <h2 className="text-xl mt-4 font-semibold text-[#F5F5F5] sm:text-2xl pr-4">We work with fast growing teams to scale go-to-market with community-based platforms and AI agents</h2>
