        ...
        <div className="relative isolate sm:pb-12">
          ...
          <div className="mx-auto max-w-7xl px-6 mt-16 lg:mt-4 pt-10 pb-24 sm:pb-32 lg:flex lg:gap-8 lg:items-center lg:px-8 lg:py-24">
            <div className="flex-1 pt-0">
              ...
              <h1 className="mt-12 text-6xl text-[#FFFFFF] font-source-serif-4 tracking-tight leading-[1.1] sm:leading-[1.025] sm:text-7xl md:text-8xl"><span className="text-[#40C1AC]">Engineer</span> momentum</h1> <h2 className="hidden sm:block mt-6 text-lg !font-display sm:text-[22px] tracking-normal text-theme-accent text-[#FFFFFF]">GenAI has transformed how we retrieve information. Relying on your marketing website to get found by potential customers is no longer enough. You need to establish familiarity and authority before customers buy <sup><a href="https://agentledgtm.com/go-to-market/gtm-motion-approach/how-to-use-7-11-4-framework-to-build-trust-and-drive-growth-for-your-business" target="_blank" className="text-[#00c951]">1</a></sup>.</h2><p className="block mt-6 text-md !font-display sm:text-lg tracking-normal text-theme-accent text-[#FFFFFF]">We help you design+build an engagement hub &mdash; powered by your content, courses, events, and group discussions; to provide lasting value to prospects, partners, and customers within your own digital garden, and as a result build trust and authority.</p>
