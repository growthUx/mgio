      ...
      <main className="relative isolate">
        <div id="digital-engagement-platform" className="mx-auto mt-8 pt-12 pb-4 max-w-7xl px-6 lg:px-8 lg:pb-12">
          <div className="mx-auto max-w-5xl sm:text-center">
            ...
            <h1 className="font-funnel-display mt-2 text-[32px] font-semibold text-[#f5f5f5] sm:text-5xl text-balance">
            Measure user events and interactions to optimize for conversion
            </h1>
